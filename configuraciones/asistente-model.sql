...
DROP INDEX UNQ_ENTIDAD_ANIO_CODIGO_CORTO;
DROP INDEX UNIQUE_ROL_PERMISO;
DROP INDEX UNIQUE_USUARIO_ROL;
...
DROP SEQUENCE ADMINISTRACION.ACUERDO_SERVICIO_ACUERDO_SERVICIO_ID_SEQ;
DROP SEQUENCE ADMINISTRACION.ACUERDO_SERVICIO_ENTIDAD_ACUERDO_SERVICIO_ENTIDAD_ID_SEQ;
DROP SEQUENCE ADMINISTRACION.ARCHIVOSIMPLE_ARCHIVOSIMPLE_ID_SEQ;
DROP SEQUENCE ADMINISTRACION.ENTIDAD_ENTIDAD_ID_SEQ;
DROP SEQUENCE ADMINISTRACION.PERSONA_PERSONA_ID_SEQ;
DROP SEQUENCE ADMINISTRACION.UNIDAD_ORGANIZATIVA_UNIDAD_ORGANIZATIVA_ID_SEQ;
DROP SEQUENCE SEGURIDAD.AUDITORIA_AUDITORIA_ID_SEQ;
DROP SEQUENCE SEGURIDAD.ENTIDADACCESO_ID_SEQ;
DROP SEQUENCE SEGURIDAD.ENTIDADACCESO_ROL_ENTIDADACCESO_ROL_ID_SEQ;
DROP SEQUENCE SEGURIDAD.PERMISO_PERMISO_ID_SEQ;
DROP SEQUENCE SEGURIDAD.ROL_PERMISO_ROL_PERMISO_ID_SEQ;
DROP SEQUENCE SEGURIDAD.ROL_ROL_ID_SEQ;
DROP SEQUENCE SEGURIDAD.USUARIO_ROL_USUARIO_ROL_ID_SEQ;
DROP SEQUENCE SEGURIDAD.USUARIO_USUARIO_ID_SEQ;
